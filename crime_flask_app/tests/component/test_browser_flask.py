...
class Test1:
    ...
    def test_username_updates(self):
        ...
        self.driver.find_element(By.ID, "email").send_keys(email)
        self.driver.find_element(By.ID, "username").clear_field()  # Clear the username before entering since autofill
    ...
    def test_email_updates(self):
        ...
        # Clear and then fill in update profile form, changing ONLY email
        self.driver.find_element(By.ID, "email").clear_field()
